      ...
      <div class="billing_details">
        <div class="row">
          <div class="col-lg-8">
            ...
            <form class="row contact_form" action="updateConect.php" method="post" novalidate="novalidate">
              ...
              <div class="col-md-12 form-group p_star">
              <input type="password" class="form-control" id="senha" name="Senha" value="" placeholder="Senha Atual do Aluno">
              <input type="password" class="form-control" id="senha" name="novaSenha" value="" placeholder="Nova Senha">
